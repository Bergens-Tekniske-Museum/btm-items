---
title: Compound-dampmaskinen
layout: default
---

# Compound-dampmaskinen: Revolusjonen i maritim fremdrift
...
1.  **Høytrykksylinder (HP):** Damp med høyt trykk fra kjelene kommer inn i den første, minste sylinderen.
2.  **Lavtrykksylinder (LP):** Istedenfor å slippes ut i atmosfæren eller en kondensator, ledes "brukt" damp fra den første sylinderen inn i en større sylinder hvor den ekspanderer videre og utfører mer arbeid.

## Hvorfor var den overlegen for skip?
...
## Videreutvikling: Triple og Quadruple Expansion

Etter hvert som kravene til effektivitet økte, la ingeniørene til flere trinn:

* **Triple Expansion:** Dampen ekspanderer gjennom tre sylindere (Høytrykk, Mellomtrykk og Lavtrykk). Dette ble standarden for nesten alle lasteskip og krigsskip fra 1880-tallet frem til dieselmotoren tok over.
* **Quadruple Expansion:** Fire trinn. Brukt på de aller største atlanterhavsdamperne (som f.eks. RMS Titanic) for å tyne ut siste rest av energi.
